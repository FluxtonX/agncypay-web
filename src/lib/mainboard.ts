...
export const mainboardInvoices: MainboardInvoice[] = [
  ...
  },
  {
    id: "MB-7044",
    invoiceNumber: "7044",
    recipient: "Atlas Talent Group",
    email: "finance@atlastalent.com",
    walletId: "AGNCY-1087",
    ...
    source: "Mainboard Payables",
    note: "Talent management retainer awaiting finance approval.",
    jobType: "Retainer",
    jobNumber: "JOB-6150",
    poNumber: "PO-2240",
    talentName: "Editorial Talent",
    talentRealName: "Atlas Talent Group",
    items: [{ title: "Campaign retainer", feeType: "Fee", qty: 1, rate: 3500 }],
  },
  {
    id: "MB-6890",
    invoiceNumber: "6890",
    recipient: "On Set Logistics",
    email: "payables@onsetlogistics.com",
    walletId: "AGNCY-7241",
    ...
    status: "Processing",
    source: "Mainboard Payables",
    note: "Location and production support payment in flight.",
    jobType: "Production Support",
    jobNumber: "JOB-5982",
    poNumber: "PO-2141",
    talentName: "Production Crew",
    talentRealName: "On Set Logistics",
