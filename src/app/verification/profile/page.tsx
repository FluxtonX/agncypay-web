...
export default function ProfilePage() {
  ...
  const rawAccountType = state.user?.accountType || "brand";
  ...
  const [formData, setFormData] = useState({
    ...
    addressLine1: state.businessSetup.addressLine1 || "",
    addressLine2: state.businessSetup.addressLine2 || "",
    city: state.businessSetup.city || "",
    stateOrProvince: state.businessSetup.stateOrProvince || "",
    postalCode: state.businessSetup.postalCode || "",
    country: state.businessSetup.country || "US",
    firstName: state.businessSetup.firstName || "",
    lastName: state.businessSetup.lastName || "",
    dob: state.businessSetup.dob || "",
    ssnLast4: state.businessSetup.ssnLast4 || ""
  });
